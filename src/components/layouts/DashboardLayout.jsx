    ...
    >
      ...
      {user && (
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <aside className="hidden lg:block w-64 bg-[#eff6ff]/80 shadow-md border-r border-blue-100 fixed top-[64px] bottom-0 left-0">
            <SideMenu activeMenue={activeMenue} />
          </aside>

          {/* Main Content */}
          <main className="flex-1 overflow-auto p-5 lg:ml-64 mt-6">
            {children}
          </main>
        </div>
      )}
